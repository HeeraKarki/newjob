    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                ...
                <h4 class="btn btn-primary btn-block header-title">Contact Type</h4>

                <form method="post" action="<?= baseurl('Admin/Contract_type_Add') ?>">
                    <div class="form-group">
                        <label for="name">Name</label>
                        <input class="form-control" id="name" name="name" aria-describedby="emailHelp" placeholder="Enter Contact Type" type="text">
                    </div>
                    <div class="row justify-content-center">
                        <button type="submit" class="btn btn-primary">Add Contact Type</button>
                    </div>
                </form>
            </div>
        </div>
