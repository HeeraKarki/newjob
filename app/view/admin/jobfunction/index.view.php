    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                ...
                <form method="post" action="<?= baseurl('Admin/JobFunction_Add') ?>">
                    <div class="form-group">
                        <label for="name">Name</label>
                        <input class="form-control" id="name" name="name" aria-describedby="emailHelp" placeholder="Enter JobFunction Name" type="text">
                    </div>
