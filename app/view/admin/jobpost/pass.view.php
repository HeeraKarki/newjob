                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-3">
                                <div class="card-box widget-flat border-custom bg-custom text-white">
                                    <i class="fi-tag"></i>
                                    <h3 class="m-b-10"><?= $job_posts->count() ?></h3>
                                    <p class="text-uppercase m-b-5 font-13 font-600">Total Job</p>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-3">
                                <div class="card-box bg-primary widget-flat border-primary text-white">
                                    <i class="fi-archive"></i>
                                    <h3 class="m-b-10"><?= count( $job_applicant); ?></h3>
                                    <p class="text-uppercase m-b-5 font-13 font-600">Pending Job Applicant</p>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-3">
                                <div class="card-box widget-flat border-success bg-success text-white">
                                    <i class="fi-help"></i>
                                    <h3 class="m-b-10"><?=  $job_applicant->where('status','interview')->count(); ?></h3>
                                    <p class="text-uppercase m-b-5 font-13 font-600">Total Job Interview</p>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-3">
                                <div class="card-box bg-danger widget-flat border-danger text-white">
                                    <i class="fi-delete"></i>
                                    <h3 class="m-b-10"><?=  $job_applicant->where('status','reject')->count(); ?></h3>
                                    <p class="text-uppercase m-b-5 font-13 font-600">Total Applicant Rejected</p>
                                </div>
                            </div>
                        </div>
                    </div>
