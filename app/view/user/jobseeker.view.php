...
<!--                    <img src="--><?//= asset('applyjob/')?><!--images/user.jpg" alt="User Images" class="img-responsive">-->
                ...
                <div class="favorites-user">
                    <div class="my-ads">
                        <a href="<?= baseurl('User/Applied_Job') ?>"><?= isset($user_details->job_seeker->job_applicants)?$user_details->job_seeker->job_applicants->count():0 ?><small>Apply Job</small></a>
                    </div>
                    <div class="favorites">
                        <a href="<?= baseurl('User/BookMark') ?>"><?= isset($user_details->job_seeker->job_bookmarks)?$user_details->job_seeker->job_bookmarks->count():0 ?><small>Favorites</small></a>
                    </div>
                </div>
            </div><!-- user-profile -->
